    ...
    return (
        <div className='container'>
            ...
            <div>
                ...
                <p>-- The other services firebase provides other than authentication are- Firebase Realtime Database, Emulator Suite, Cloud Storage, Cloud Firestore, Cloud Messaging, Machine Learning, Firebase Hosting, Cloud Functions, Google Analytics, Remote Config, and so on.</p>
            </div>
        </div>
    );
};
